...
import com.galiyara.sandy.galiyara.GImageCropper.CropImageOptions;
...
public class CropImageActivity extends CAppCompatActivity
    ...
    if (actionBar != null) {
      CharSequence title = mOptions != null &&
          mOptions.activityTitle != null && mOptions.activityTitle.length() > 0
              ...
              : getResources().getString(R.string.crop_image_activity_title);if(Build.VERSION.SDK_INT >= 23)
            requestPermissions(
                    new String[] {Manifest.permission.READ_EXTERNAL_STORAGE},
                    CropImage.PICK_IMAGE_PERMISSIONS_REQUEST_CODE);
